...
- Dynamic memory mangement will be used when dealing with user input (command parser using the `delete` operator)
...
- Dynmaic memory mangement to clean up game state after each battle has been completed
